...
public class Empresa {
    ...
    private final StringProperty plazas = new SimpleStringProperty();
    private final StringProperty especialidad = new SimpleStringProperty();

    public Empresa(int id_Empresa, String nombre, String direccion, String telefono, String email, boolean participa, String plazas, String especialidad) {
    ...
    public int getPlazas() {
        return Integer.parseInt(plazas.get());
    }

    public StringProperty plazasProperty() {
        return plazas;
    }

    public void setPlazas(int plazas) {
        this.plazas.set(String.valueOf(plazas));
    }
