...
public class EmpresaSelectedController implements Initializable {
    ...
    void onActualizarAction(ActionEvent event) {
        ...
        Integer plazas = Integer.parseInt(Plazas.getText());
        Boolean participa = Participa.isSelected();
        Integer id = Integer.parseInt(empresa.getId_Empresa().getText());
        String sql = "UPDATE empresas SET Id_Empresa=?,Nombre=?,Direccion=?,Especialidad=?,Telefono=? WHERE Id_Empresa=?";
