...
public class VisitaController implements Initializable {
    ...
    void onAñadirAction(ActionEvent event) {
         ...
         if (visitaCreateController.isConfirmar()){
             String idAlumno = visitaCreateController.getIdAlumno().getId();
             Integer idAlumnoVerdad = Integer.parseInt(idAlumno);
             String idTutor = visitaCreateController.getIdTutor().getId();
             Integer idTutorVerdad = Integer.parseInt(idTutor);
             ...
             int nuevoId =  insertarVisita(fecha,observaciones,idAlumnoVerdad,idAlumnoVerdad);
             if (nuevoId > 0){
                 cargarTablaVisita();
             }else {
    ...
    private int insertarVisita(LocalDate fecha,String observaciones,Integer idAlumno,Integer idTutor){
    ...
    public void initialize(URL location, ResourceBundle resources) {
        IdVisitas.setCellValueFactory(new PropertyValueFactory<>("Id_Visita"));
